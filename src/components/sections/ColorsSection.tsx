...
import { featuredColors, type ResinColorData } from "@/lib/colors";

export function ColorsSection() {
  const [selectedColor, setSelectedColor] = useState<ResinColorData | null>(null);
        ...
        <div className="mx-auto max-w-[1200px] px-6">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <p className="text-base text-gray-500 mt-4 max-w-xl mx-auto leading-relaxed">
                Over 150 stunning resin bound colour blends available. Here are some of our most popular choices.
              </p>
            </div>
          </ScrollReveal>
            ...
            <AnimatePresence mode="wait">
              {featuredColors.map((color) => (
                <StaggerItem key={color.slug}>
                  ...
                  >
                    <div className="relative aspect-square rounded-2xl overflow-hidden shadow-sm mb-3 ring-1 ring-black/5 group-hover:shadow-lg transition-shadow duration-300 bg-gray-100">
                      <Image
          ...
          <AnimatePresence>
            {selectedColor && (
              ...
              >
                <div className="relative w-20 h-20 rounded-xl overflow-hidden shadow-md flex-shrink-0 ring-1 ring-black/5 bg-gray-100">
                  <Image
                    src={`${selectedColor.image}&width=160`}
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-sm text-gray-500">
                    {selectedColor.family} tone — premium resin bound aggregate blend
                  </p>
          ...
          <ScrollReveal>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mt-4">
                Browse the complete colour catalogue — every colour comes with a{" "}
